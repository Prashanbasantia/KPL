# Generated by Django 3.2.4 on 2022-02-20 06:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bolw_wicket', models.IntegerField(default=0)),
                ('bolw_runs', models.IntegerField(default=0)),
                ('bolw_balls', models.IntegerField(default=0)),
                ('bolw_economy', models.FloatField(default=0.0)),
                ('bolw_average', models.FloatField(default=0.0)),
                ('bolw_best_bowling', models.IntegerField(default=0)),
                ('bolw_three_wkt', models.IntegerField(default=0)),
                ('bolw_five_wkt', models.IntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now_add=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bat_fours', models.IntegerField(default=0)),
                ('bat_sixes', models.IntegerField(default=0)),
                ('bowl_status', models.CharField(choices=[('Not Bowling', 'Nbw'), ('Bowling', 'Bw')], default='Not Bowling', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bowler', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='bowler', to='Admin_App.players')),
                ('matchinfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Admin_App.matchinfo')),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Admin_App.teams')),
            ],
        ),
